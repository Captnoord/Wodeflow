...
void CMenu::_showConfigSnd(void)
{
	...
	m_btnMgr.setText(m_configSndLblGuiVolVal, wfmt("%i", m_cfg.getInt("GENERAL", "sound_volume_gui", 255)));
	m_btnMgr.setText(m_configSndLblCFVolVal, wfmt("%i", m_cfg.getInt("GENERAL", "sound_volume_coverflow", 255)));
	m_btnMgr.setText(m_configSndLblMusicVolVal, wfmt("%i", m_cfg.getInt("GENERAL", "sound_volume_music", 255)));
	m_btnMgr.setText(m_configSndLblBnrVolVal, wfmt("%i", m_cfg.getInt("GENERAL", "sound_volume_bnr", 255)));
}
