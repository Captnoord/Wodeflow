...
void CMenu::_showConfigSnd(void)
{
	...
	m_btnMgr.setText(m_configSndLblGuiVolVal, wfmt("%i", m_cfg.getInt(" GENERA", "sound_volume_gui", 255)));
	m_btnMgr.setText(m_configSndLblCFVolVal, wfmt("%i", m_cfg.getInt(" GENERA", "sound_volume_coverflow", 255)));
	m_btnMgr.setText(m_configSndLblMusicVolVal, wfmt("%i", m_cfg.getInt(" GENERA", "sound_volume_music", 255)));
	m_btnMgr.setText(m_configSndLblBnrVolVal, wfmt("%i", m_cfg.getInt(" GENERA", "sound_volume_bnr", 255)));
}
...
int CMenu::_configSnd(void)
{
	...
	while (true)
	{
		...
		if ((padsState & WPAD_BUTTON_A) != 0)
		{
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_bnr", min(m_cfg.getInt(" GENERA", "sound_volume_bnr", 255) + step, 255));
				_showConfigSnd();
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_bnr", max(m_cfg.getInt(" GENERA", "sound_volume_bnr", 255) - step, 0));
				_showConfigSnd();
				m_bnrSndVol = m_cfg.getInt(" GENERA", "sound_volume_bnr", 255);
				repeat = true;
			}
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_gui", min(m_cfg.getInt(" GENERA", "sound_volume_gui", 255) + step, 255));
				_showConfigSnd();
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_gui", max(m_cfg.getInt(" GENERA", "sound_volume_gui", 255) - step, 0));
				_showConfigSnd();
				m_btnMgr.setSoundVolume(m_cfg.getInt(" GENERA", "sound_volume_gui", 255));
				repeat = true;
			}
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_music", min(m_cfg.getInt(" GENERA", "sound_volume_music", 255) + step, 255));
				_showConfigSnd();
				SetVolumeOgg(m_cfg.getInt(" GENERA", "sound_volume_music", 255));
				MP3Player_Volume(m_cfg.getInt(" GENERA", "sound_volume_music", 255));
				repeat = true;
			}
			else if (m_btnMgr.selected() == m_configSndBtnMusicVolM)
			{
				m_cfg.setInt(" GENERA", "sound_volume_music", max(m_cfg.getInt(" GENERA", "sound_volume_music", 255) - step, 0));
				_showConfigSnd();
				SetVolumeOgg(m_cfg.getInt(" GENERA", "sound_volume_music", 255));
				MP3Player_Volume(m_cfg.getInt(" GENERA", "sound_volume_music", 255));
				repeat = true;
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_coverflow", min(m_cfg.getInt(" GENERA", "sound_volume_coverflow", 255) + step, 255));
				_showConfigSnd();
			...
			{
				m_cfg.setInt(" GENERA", "sound_volume_coverflow", max(m_cfg.getInt(" GENERA", "sound_volume_coverflow", 255) - step, 0));
				_showConfigSnd();
				m_cf.setSoundVolume(m_cfg.getInt(" GENERA", "sound_volume_coverflow", 255));
				repeat = true;
			}
...
void CMenu::_initConfigSndMenu(CMenu::SThemeData &theme)
{
	...
	m_configSndLblMusicVol = _addLabel(theme, "CONFIGSND/MUSIC_VO", theme.lblFont, "", 40, 130, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configSndLblMusicVolVal = _addLabel(theme, "CONFIGSND/MUSIC_VOL_BTN", theme.btnFont, "", 426, 130, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configSndLblGuiVol = _addLabel(theme, "CONFIGSND/GUI_VO", theme.lblFont, "", 40, 190, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configSndLblGuiVolVal = _addLabel(theme, "CONFIGSND/GUI_VOL_BTN", theme.btnFont, "", 426, 190, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configSndLblCFVol = _addLabel(theme, "CONFIGSND/CF_VO", theme.lblFont, "", 40, 250, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configSndLblCFVolVal = _addLabel(theme, "CONFIGSND/CF_VOL_BTN", theme.btnFont, "", 426, 250, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configSndLblBnrVol = _addLabel(theme, "CONFIGSND/BNR_VO", theme.lblFont, "", 40, 310, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configSndLblBnrVolVal = _addLabel(theme, "CONFIGSND/BNR_VOL_BTN", theme.btnFont, "", 426, 310, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	// 
	_setHideAnim(m_configSndLblMusicVol, "CONFIGSND/MUSIC_VO", 100, 0, -2.f, 0.f);
	...
	_setHideAnim(m_configSndLblGuiVol, "CONFIGSND/GUI_VO", 100, 0, -2.f, 0.f);
	...
	_setHideAnim(m_configSndLblCFVol, "CONFIGSND/CF_VO", 100, 0, -2.f, 0.f);
	...
	_setHideAnim(m_configSndLblBnrVol, "CONFIGSND/BNR_VO", 100, 0, -2.f, 0.f);
...
{
	m_btnMgr.setText(m_configSndLblMusicVol, _t("cfgs1", "Music volume"));
	m_btnMgr.setText(m_configSndLblGuiVol, _t("cfgs2", "GUI sound volume"));
	m_btnMgr.setText(m_configSndLblCFVol, _t("cfgs3", "Coverflow sound volume"));
	m_btnMgr.setText(m_configSndLblBnrVol, _t("cfgs4", "Game sound volume"));
}
